      ...
      <el-tabs v-model="activeTab" @tab-change="handleTabChange">
        ...
        <el-tab-pane label="分析结果" name="result" :disabled="!hasResult">
          ...
          <div v-else-if="analysisResult" class="result-content">
            ...
            <!-- SHAP解释分析 -->
            <ShapExplanation
              v-if="shapInstanceData || shapGlobalData"
...
export default {
  ...
  setup() {
    ...
    const shapInstanceData = ref(null) // SHAP单样本解释数据
    const shapGlobalData = ref(null) // SHAP全局重要性数据
